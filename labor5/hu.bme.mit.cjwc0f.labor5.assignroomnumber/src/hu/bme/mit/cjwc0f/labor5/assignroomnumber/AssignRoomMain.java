...
public class AssignRoomMain {
	...
	public static void main(String[] args) {
		...
		final SenderActorCreator creator = new SenderActorCreator("127.0.0.1", IAkkaNames.FINAL_STUDY_ACTOR, IAkkaNames.FINAL_RESULT_PORT, IAkkaNames.FINAL_RESULT_SYSTEM, outQueue);
