...
public class EnterDataWindow extends AbstractWindow {
	...
	public EnterDataWindow(EnterDataWorker enterDataWorker) {
		...
		JButton generateAutomatedData = new JButton();
		generateAutomatedData.setText("Automatically generate 1000 data");
		generateAutomatedData.addActionListener(new ActionListener() {

			@Override
			public void actionPerformed(ActionEvent e) {
				enterDataWorker.clickedAutomatic();
			}

		});
		this.getContentPane().add(generateAutomatedData, BorderLayout.NORTH);
	}
